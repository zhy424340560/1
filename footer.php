                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3 footer-list text-center">
                                   ...
                                   <p> © <?php echo date('Y'); ?> <a href="<?php echo get_option('home'); ?>"><?php bloginfo('name'); ?></a>. <a target="_blank" href="https://myssl.com/seal/detail?domain=ipuser.cn" style="display:inline-block;text-decoration:none;height:25px;line-height:25px;"><img src="https://home.ipuser.cn/IMG/seal.png" style="display:inline-block;text-decoration:none;height:25px;line-height:25px;"></a> | <?php _e('已在风雨中度过','moedog'); ?> <span id="span_dt_dt">Loading...</span><?php if(kratos_option('sitemap')) echo ' | <a href="'.get_option('home').'/sitemap.html" target="_blank">Sitemap</a>'; ?>
										<br>感谢给开心分享提供技术支持的企业：<a target="_blank" href="https://www.upyun.com/" style="display:inline-block;text-decoration:none;height:25px;line-height:25px;"><img src="https://home.ipuser.cn/2020/04/upyun.png" style="display:inline-block;text-decoration:none;height:25px;line-height:25px;"></a>
